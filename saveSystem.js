...
class EquipmentSystem {
    constructor() {
        ...
        this.equipmentIcons = {
            // 武器图标 - 匹配实际装备ID
            'rusty_dagger': 'fa-dagger',
            'copper_shortsword': 'fa-sword',
            'wooden_sword': 'fa-sword',
            'stone_hammer': 'fa-hammer',
            'wooden_bow': 'fa-bow-arrow',
            'bronze_spear': 'fa-spear',
            
            // 绿色品质武器
            'silver_dagger': 'fa-khanda',
            'iron_sword': 'fa-sword-laser',
            'war_hammer': 'fa-hammer-crash',
            'composite_bow': 'fa-bow-arrow',
            'steel_spear': 'fa-spear',
            'twin_knives': 'fa-scalpel',
            'iron_club': 'fa-club',
            
            // 蓝色品质武器
            'shadow_blade': 'fa-sword-laser',
            'gold_sword': 'fa-sword-laser',
            'battle_axe': 'fa-axe-battle',
            'elven_bow': 'fa-bow-arrow',
            'crystal_spear': 'fa-spear',
            'flaming_sword': 'fa-sword-laser',
            'frost_hammer': 'fa-hammer-crash',
            'lightning_dagger': 'fa-dagger',
            
            // 紫色品质武器
            'excalibur': 'fa-sword-laser',
            'muramasa': 'fa-sword-laser',
            'dragon_slayer': 'fa-axe-battle',
            'phoenix_bow': 'fa-bow-arrow',
            'gungnir': 'fa-spear',
            'blade_of_abyss': 'fa-sword-laser',
            'thor_hammer': 'fa-hammer-crash',
            'celestial_sword': 'fa-sword-laser',
            
            // 防具图标
            'cloth_robe': 'fa-vest',
            'leather_armor': 'fa-shield',
            'wooden_shield': 'fa-shield',
            'chain_mail': 'fa-shield',
            'scale_armor': 'fa-shield-halved',
            'iron_shield': 'fa-shield',
            'plate_armor': 'fa-shield-virus',
            'magic_robe': 'fa-vest-patches',
            'steel_shield': 'fa-shield',
            'dragon_scale': 'fa-shield-virus',
            'ethereal_armor': 'fa-shield-virus',
            'celestial_plate': 'fa-shield-virus',
            
            // 饰品图标
            'copper_ring': 'fa-ring',
            'wooden_amulet': 'fa-amulet',
            'stone_charm': 'fa-gem',
            'silver_ring': 'fa-gem',
            'protection_amulet': 'fa-amulet',
            'iron_charm': 'fa-gem',
            'gold_ring': 'fa-gem',
            'wisdom_amulet': 'fa-amulet',
            'magic_charm': 'fa-gem',
            'eternal_ring': 'fa-gem',
            'divine_amulet': 'fa-amulet',
            'legendary_charm': 'fa-gem'
        };
